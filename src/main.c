...
static int draw_zero(GContext *ctx, int x, int y) {
  ...
  graphics_fill_rect(ctx, GRect(x+5, y-1, 6, 4), 0, GCornerNone);
  graphics_fill_rect(ctx, GRect(x+5, y+30, 6, 4), 0, GCornerNone);
...
static int draw_two(GContext *ctx, int x, int y) {
  ...
  graphics_fill_rect(ctx, GRect(x+5, y-1, 6, 4), 0, GCornerNone);
  graphics_fill_rect(ctx, GRect(x+5, y+14, 6, 4), 0, GCornerNone);  
  graphics_fill_rect(ctx, GRect(x+5, y+30, 6, 4), 0, GCornerNone);
...
void handle_init(void) {
  ...
  tick_timer_service_subscribe(SECOND_UNIT, (TickHandler)handle_minute_tick);
}
